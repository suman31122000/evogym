const Join=()=>{
    return(
    <div className="h-screen w-full  px-20 py-10">
        <div className="h-[20%] w-full flex flex-col">
            ...
            <span>Join our gym for a transformative fitness experience like no other! At our gym, we're more than just a place to work out – we're a community dedicated to helping you achieve your health and wellness goals, whatever they may be</span>
        </div>
        <div className="h-[80%] w-full flex gap-5">
            ...
            <div className="h-full w-[50%] bg-slate-600 " style={{ backgroundImage: "url('imag1.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
